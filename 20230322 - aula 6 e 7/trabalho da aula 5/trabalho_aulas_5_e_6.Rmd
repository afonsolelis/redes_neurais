...
## Previsão em janelas de 5 períodos móveis (mobilidade de 1 período)
...
plot_results <- function(model, data) {
  ...
  plot(seq(1, length(data$targetsTrain)),
       data$targetsTrain,
       xlab = "x",
       ylab = "y",
       type = "p",
  ...
  plot(seq(1, length(data$targetsTest)),
       data$targetsTest,
       xlab = "x",
       ylab = "y",
       type = "p",
...
## Previsão em janelas de 10 períodos móveis (mobilidade de 1 período)
...
## Previsão em janelas de 15 períodos móveis (mobilidade de 1 período)
...
## Previsão em janelas de 20 períodos móveis (mobilidade de 1 período)
